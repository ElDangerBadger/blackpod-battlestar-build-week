...
export type NavigatorOceanMarketSummary = NavigatorOceanMarket["summary"];
export type NavigatorOceanTimeframe = NavigatorOceanMarket["timeframe"];
export type NavigatorOceanVolatility = NavigatorOceanMarket["summary"]["volatility"];
